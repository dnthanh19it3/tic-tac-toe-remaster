...
let sourceAccount = 0;
let betPrice = 0.3;
const bankAddress = "30499e2399e56df7d27ba0bcb72cfceeeb80e0cbd0b69223b43f1fd6753173c3";
...
var newGameHandler = function(){
    ...
    if (typeof TicTacToe != 'undefined'){
        ...
        // { from: sourceAccount, to: bankAddress, value: betPrice }
        var opponentAddress = document.getElementById('opponentAdress').value
        TicTacToeContract.new(opponentAddress, function(error, txHash){
